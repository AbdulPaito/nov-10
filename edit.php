...
// Fetch user data if a user_id is provided
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    $user_id = intval($_GET['id']); // Use user_id for clarity
} else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($new_password)) {
        if ($new_password === $confirm_password) {
            ...
            $query = "UPDATE users SET password = ? WHERE user_id = ?"; // Use user_id in the query
            $params = [$new_password, $user_id]; // Use user_id here as well
