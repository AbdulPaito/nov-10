...
// New query with multiple JOIN operations
$query = "
   SELECT 
    u.*, 
    ppi.profile_image, ppi.imageUpload,
    pi.last_name, pi.first_name, pi.middle_name, pi.nationality, pi.sex, pi.civil_status, pi.employment_status, pi.month_of_birth, pi.day_of_birth, pi.year_of_birth, pi.age,
    bi.*, 
    ci.*, 
    di.*, 
    ei.*, 
